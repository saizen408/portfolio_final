  ...
  return (
    <Layout title={`Skills`} bgClassName={`skill`} fixedMenuPosition={true}>
      ...
      <Skill
        ...
        type="scrollable"
        title="Skills"
        description="These are the skills that I have acquired through rigorous study and projects I've worked on. The order is loosely based on the ones I like most and/or have used most frequently."
